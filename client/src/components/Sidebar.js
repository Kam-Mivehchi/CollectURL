...
export default function Sidebar() {
   ...
   return (
      <>
         <nav className="md:left-0 md:block md:absolute  md:min-h-screen md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6">
